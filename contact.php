...
// print_r($_POST);
if (isset($_POST['name'])) {
$query="INSERT INTO contact_data(`name`, `email`, `subject`, `message`, `cdate`) VALUES ('".$_POST['name']."','".$_POST['email']."','".$_POST['subject']."','".$_POST['message']."','".date('Y-m-d h:i:s')."')";
  $fire=mysqli_query($conn,$query);
if ($fire) {
echo "<script>alert('Your Data Has Been Sent Successfully');window.location.href='contact.php';</script>";
}
else {
    echo "Something Error! Record Was Not Sent";
}
