...
<div class="d-flex flex-row align-items-center mt-1 mb-1 color-white">
    ...
    <div class="info-card-text">
        <div class="fs-lg text-truncate text-truncate-lg">Mr. Dhiraj Phatake</div>
        <span class="text-truncate text-truncate-md opacity-80">dhirajphatake185@gmail.com</span>
    </div>
</div>
</div>
